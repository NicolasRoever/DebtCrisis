...
from debt_crisis.regression_analysis.regression_analysis import (
    ...
    create_dataset_for_factor_model_regression,
)
...
dependencies_task_create_dataset_for_factor_model_regression = {
...
def task_create_dataset_for_factor_model_regression(
    depends_on=dependencies_task_create_dataset_for_factor_model_regression,
    produces=BLD / "factor_models" / "factor_model_dataset.pkl",
):
    ...
    dataset = create_dataset_for_factor_model_regression(
        bond_yield_data=bond_yield_data,
        debt_to_gdp_data=debt_to_gdp_data,
        ratings_data=ratings_data,
        gdp_data=gdp_data,
        current_account_data=current_account_data,
        stoxx_data=stoxx_data,
    )
